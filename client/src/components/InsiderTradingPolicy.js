...
Exclude any other details from the policy like definitions, purpose, effective date, etc.`;
    ...
    try {
        ...
        onResponse: async (data) => {
          ...
          if (data && data.candidates && data.candidates[0] && data.candidates[0].content) {
            ...
            await trackActivity({
              ...
              feature: FEATURES.INSIDER_TRADING_POLICY,
              action: 'Insider Trading Policy Generated Successfully',
              inputData: {
            ...
            await trackActivity({
              activityType: ACTIVITY_TYPES.POLICY_GENERATION,
              feature: FEATURES.INSIDER_TRADING_POLICY,
              action: 'Insider Trading Policy Generation Failed',
              inputData: {
                companyName: formData.companyName
              },
              outputData: {
      ...
      await trackActivity({
        activityType: ACTIVITY_TYPES.POLICY_GENERATION,
        feature: FEATURES.INSIDER_TRADING_POLICY,
        action: 'Insider Trading Policy Generation Error',
        inputData: {
          companyName: formData.companyName
        },
        outputData: {
