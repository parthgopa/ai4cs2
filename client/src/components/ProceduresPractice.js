...
`;
    ...
    try {
        ...
        onResponse: async (data) => {
          ...
          if (data && data.candidates && data.candidates[0] && data.candidates[0].content && data.candidates[0].content.parts) {
            ...
            await trackActivity({
              ...
              feature: 'Procedures Practice',
              action: 'Generated procedures and practice guide',
              inputData: {
                entityType: formData.entityType,
                factsOfCase: formData.factsOfCase,
            ...
            await trackActivity({
              activityType: ACTIVITY_TYPES.DOCUMENT_GENERATION,
              feature: 'Procedures Practice',
              action: 'Failed to generate procedures and practice guide',
              inputData: {
                entityType: formData.entityType,
                factsOfCase: formData.factsOfCase,
                customProcedure: formData.customProcedure,
      ...
      await trackActivity({
        activityType: ACTIVITY_TYPES.DOCUMENT_GENERATION,
        feature: 'Procedures Practice',
        action: 'Error in generating procedures and practice guide',
        inputData: {
          entityType: formData.entityType,
          factsOfCase: formData.factsOfCase,
          customProcedure: formData.customProcedure,
